...
/**
 * custom viewfinderview
 * Created by zack on 2018/2/28.
 */

public class HsbcFinderView extends ViewfinderView{
    public HsbcFinderView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    /**
     * 重绘时间间隔
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (resultBitmap != null) {
            ...
            if(mScanLinePosition > frame.height()-mLineDepth){
                mScanLinePosition = 0;
            }
